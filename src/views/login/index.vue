<template>
  <div id="login">
    ...
    <div class="login_content">
      <p><span class="left-quote"></span><span>Fangte·云平台</span></p>
      <p><span>办公高效更有趣</span><span class="right-quote"></span></p>
    </div>
    <p class="power_by">© 2020 - 2020 HQFT All Rights Reserved</p>
  </div>
</template>
